...
var _user$project$Common$pointsString = function (points) {
	var _p0 = points;
	switch (_p0) {
		case -1:
			return '-';
		case 1000:
			return '∞';
		default:
			return _elm_lang$core$Basics$toString(points);
	}
};
var _user$project$Common$Story = F3(
	function (a, b, c) {
		return {name: a, points: b, owner: c};
	});
var _user$project$Common$User = F2(
	function (a, b) {
		return {name: a, id: b};
	});
...
var _user$project$Types$isStoryOwner = function (model) {
	...
	if (_p1.ctor === 'Just') {
		var _p2 = model.team;
		if (_p2.ctor === 'Just') {
			var _p3 = _p2._0.story;
			if (_p3.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p1._0.id, _p3._0.owner.id);
			} else {
				return false;
			}
		} else {
...
var _user$project$Types$hasVoted = function (model) {
	...
	if (_p4.ctor === 'Nothing') {
		...
		var existingVotes = A2(
			...
			model.votes);
		return !_elm_lang$core$List$isEmpty(existingVotes);
	}
};
...
var _user$project$Types$loadTeam = _elm_lang$core$Native_Platform.outgoingPort(
	'loadTeam',
	function (v) {
		return v;
	});
var _user$project$Types$teamChanged = _elm_lang$core$Native_Platform.incomingPort(
	'teamChanged',
...
var _user$project$Types$subscribeToTeam = _elm_lang$core$Native_Platform.outgoingPort(
	'subscribeToTeam',
	function (v) {
		return v;
	});
...
var _user$project$Types$LocationTeam = function (a) {
...
var _user$project$Types$EditUserDialogClose = {ctor: 'EditUserDialogClose'};
var _user$project$Types$EditUserDialog = {ctor: 'EditUserDialog'};
var _user$project$Types$CreateUser = {ctor: 'CreateUser'};
var _user$project$Types$StartStorySizing = {ctor: 'StartStorySizing'};

var _user$project$Router$locationParser = function (location) {
	var hash = A2(_elm_lang$core$String$dropLeft, 1, location.hash);
	var _p0 = hash;
	if (_p0 === '') {
		return _user$project$Types$LocationHome;
	} else {
		return _user$project$Types$LocationTeam(hash);
	}
};
...
var _user$project$State$getTeam = function (model) {
	var _p1 = model.team;
	if (_p1.ctor === 'Nothing') {
		return _elm_lang$core$Native_Utils.crashCase(
			'State',
...
var _user$project$State$saveVote = F2(
	function (model, points) {
		var existingVotes = A2(
			...
			model.votes);
		var _p6 = existingVotes;
		if ((_p6.ctor === '::') && (_p6._1.ctor === '[]')) {
			return _elm_lang$core$Native_Utils.eq(_p6._0.points, points) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			var _p7 = _user$project$State$getTeam(model).story;
			if (_p7.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: model,
...
var _user$project$State$initTeam = function (teamInfo) {
	return {id: teamInfo.id, name: teamInfo.name, story: _elm_lang$core$Maybe$Nothing};
};
		...
		switch (_p8.ctor) {
			case 'LocationHome':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{team: _elm_lang$core$Maybe$Nothing, isDataLoaded: true}),
			...
			case 'LocationTeam':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isDataLoaded: false}),
					_1: _user$project$Types$loadTeam(_p8._0)
				};
			case 'TeamChanged':
				var _p9 = _p8._0;
				if (_p9.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								team: _elm_lang$core$Maybe$Just(
			...
			case 'CreateUser':
				if (_elm_lang$core$String$isEmpty(
					_elm_lang$core$String$trim(model.userInput))) {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var user = A2(_user$project$Common$User, model.userInput, model.uuid);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'Size':
				return A2(_user$project$State$saveVote, model, _p8._0);
			case 'VoteAdded':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							votes: {ctor: '::', _0: _p8._0, _1: model.votes}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectVote':
				...
				var sizedStory = function () {
					...
					if (_p11.ctor === 'Nothing') {
						...
						return _elm_lang$core$Native_Utils.update(
							_p11._0,
							{points: _p8._0.points});
					}
				}();
				var updatedTeam = _elm_lang$core$Native_Utils.update(
					team,
					{
			...
			case 'StorySizingStarted':
				var team = _user$project$State$getTeam(model);
				var udatedTeam = _elm_lang$core$Native_Utils.update(
					team,
					{
						story: _elm_lang$core$Maybe$Just(_p8._0)
					});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							team: _elm_lang$core$Maybe$Just(udatedTeam),
							storyInput: '',
							isDataLoaded: true
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$State$init = F2(
	function (flags, location) {
		...
		return (!(_elm_lang$core$Native_Utils.eq(flags.userName, '') || _elm_lang$core$Native_Utils.eq(flags.userId, ''))) ? {
			...
			_0: _elm_lang$core$Native_Utils.update(
				_user$project$State$initModel,
				{uuid: flags.uuid, isDataLoaded: isDataLoaded}),
			_1: cmd
		};
	});
var _user$project$State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Types$voteAdded(_user$project$Types$VoteAdded),
			_1: {
				ctor: '::',
...
var _user$project$PartialViews_Title$root = function (title) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-tile-header'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('iq-tile-header__title'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$PartialViews_EnterStory$root = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-tile iq-tile--gr gr-form gr-size-form'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Types$StartStorySizing),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('gr-form-element'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('Story name'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$StoryInput),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.storyInput),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('iq-btn iq-btn--primary iq-btn--large'),
									_1: {
										ctor: '::',
...
var _user$project$PartialViews_Votes$votePoints = F2(
	function (model, vote) {
		return (!_user$project$Types$hasVoted(model)) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('gr-estimator-points'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('iq-btn'),
						_1: {
							ctor: '::',
...
var _user$project$PartialViews_Votes$voteEntry = F2(
	function (model, vote) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('iq-list__item'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(_user$project$PartialViews_Votes$votePoints, model, vote),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('gr-estimator-name'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$PartialViews_Votes$votes = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-list'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
...
var _user$project$PartialViews_Votes$votesHeader = function (model) {
	return _elm_lang$core$List$isEmpty(model.votes) ? _elm_lang$html$Html$text('') : ((!_user$project$Types$hasVoted(model)) ? A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Select a vote below'),
			_1: {ctor: '[]'}
		}) : A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-list--header'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('iq-item-title gr-estimator-name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('iq-item-title gr-estimator-points'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$PartialViews_CancelStoryDialog$root = function (model) {
	return model.showCancelStoryDialog ? A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('modal-window'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('modal-close iq-pull-right'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$CancelStoryDialogClose),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Dismiss current story and start new session?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('iq-btn iq-btn--primary'),
									_1: {
										ctor: '::',
...
var _user$project$PartialViews_Sizing$sizingButtons = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('gr-button-grid'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('iq-btn iq-btn--square points'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('0.5'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('13'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$PartialViews_Sizing$headerButtons = function (model) {
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('iq-btn iq-btn--tertiary'),
				_1: {
					ctor: '::',
...
var _user$project$PartialViews_Sizing$header = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-tile__actions'),
			_1: {ctor: '[]'}
		},
...
var _user$project$PartialViews_Results$root = F2(
	function (storyName, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('iq-tile iq-tile--gr scoreboard fieldset'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$PartialViews_CreateUser$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('gr-form'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Types$CreateUser),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('gr-form-element gr-form-element--user'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$UserInput),
											_1: {
												ctor: '::',
...
var _user$project$PartialViews_EditUserDialog$root = function (model) {
	return model.showEditUserDialog ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('modal-window'),
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$EditUserDialogClose),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						ctor: '::',
						_0: _user$project$PartialViews_CreateUser$root(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$PartialViews_Header$currentUser = function (model) {
	var _p0 = model.user;
	if (_p0.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$span,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('gr-user'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$EditUserDialog),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$PartialViews_Header$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-header'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('iq-header__inner'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('gr-team-meta'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _user$project$PartialViews_Header$currentUser(model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('iq-title'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$alt('Ladies and gentlemen Mr Robert Johnson.'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('iq-pull-left'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('images/mr_johnson.png'),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('iq-title__brand'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Dust My Groom'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('iq-title__version'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('I believe, I believe my time has come'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
						...
						_1: {
							ctor: '::',
							_0: _user$project$PartialViews_EditUserDialog$root(model),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$PartialViews_Team$teamName = function (model) {
	var _p0 = model.team;
	if (_p0.ctor === 'Nothing') {
		return {ctor: '[]'};
	} else {
...
var _user$project$PartialViews_Team$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-tile iq-tile--gr iq-tile--breadcrumb'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('gr-team'),
					_1: {ctor: '[]'}
				},
				_user$project$PartialViews_Team$teamName(model)),
			_1: {ctor: '[]'}
		});
};

var _user$project$View$loadingPage = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('iq-tile iq-tile--gr'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _user$project$PartialViews_Title$root('loading...'),
		_1: {ctor: '[]'}
	});
var _user$project$View$selectTeam = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$View$root = function (model) {
	var content = _elm_lang$core$Native_Utils.eq(model.user, _elm_lang$core$Maybe$Nothing) ? _user$project$View$createUser(model) : ((!model.isDataLoaded) ? _user$project$View$loadingPage : _user$project$View$grooming(model));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('iq-container--elm'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$PartialViews_Header$root(model),
			_1: {
				ctor: '::',
				_0: _user$project$PartialViews_Team$root(model),
				_1: {
					ctor: '::',
					_0: content,
					_1: {ctor: '[]'}
...
var _user$project$Main$main = A2(
	...
	_user$project$Router$locationParser,
	{init: _user$project$State$init, update: _user$project$State$update, view: _user$project$View$root, subscriptions: _user$project$State$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (userId) {
			return A2(
				...
				function (userName) {
					return A2(
						...
						function (uuid) {
							return _elm_lang$core$Json_Decode$succeed(
								{userId: userId, userName: userName, uuid: uuid});
						},
