	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('hostory-record'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {user: a, uuid: b, team: c, storyInput: d, userInput: e, error: f, votes: g, revealVotes: h, isDataLoaded: i, hisotryModel: j, showCancelStoryDialog: k};
										};
									};
								};
							};
...
var _user$project$State$getUser = function (model) {
	...
	if (_p3.ctor === 'Nothing') {
		return _elm_lang$core$Native_Utils.crashCase(
			'State',
			{
				start: {line: 286, column: 5},
				end: {line: 291, column: 17}
			},
...
var _user$project$Layout_State$init = F2(
	function (flags, location) {
		var _p0 = A2(_user$project$State$init, flags, location);
...
var _user$project$Layout_State$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Layout_Types$Mdl, _p1._0, model);
			case 'SelectTab':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
...
var _user$project$PartialViews_Votes$votePoints = F2(
	function (model, vote) {
		return (!_user$project$Types$hasVoted(model)) ? {
			...
			_1: {ctor: '[]'}
		} : (_user$project$Types$isStoryOwner(model) ? {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$button,
				{
...
var _user$project$PartialViews_Results$root = F2(
	function (storyName, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('scoreboard fieldset'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$View$root = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.user, _elm_lang$core$Maybe$Nothing) ? _user$project$View$createUser(model) : ((!model.isDataLoaded) ? _user$project$View$loadingPage(model) : _user$project$View$grooming(model));
};

var _user$project$Layout_View$viewNav = function (model) {
	var page = function () {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Grid$maxWidth('575px'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Layout_View$teamName = function (model) {
	var _p1 = model.team;
	if (_p1.ctor === 'Nothing') {
		return '';
	} else {
...
var _user$project$Layout_View$userName = function (model) {
	return function (_) {
		return _.name;
	}(
		A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$Common$User, '', ''),
			model.user));
};
var _user$project$Layout_View$userTab = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		_user$project$Layout_View$userName(model.groomingModel),
		'') ? _elm_lang$html$Html$text('User') : _elm_lang$html$Html$text(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'User (',
			A2(
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Layout$onSelectTab(_user$project$Layout_Types$SelectTab),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			},
			{
				header: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('mdl-layout__title'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_user$project$Layout_View$teamName(model.groomingModel)),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				tabs: {
					...
					_0: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Grooming'),
						_1: {
							ctor: '::',
							_0: _user$project$Layout_View$userTab(model),
							_1: {ctor: '[]'}
						}
					},
					_1: {
				...
				main: {
					ctor: '::',
					_0: _user$project$Layout_View$viewNav(model),
					_1: {ctor: '[]'}
				}
			}));
};

var _user$project$MainWithLayout$layoutLocationParser = function (location) {
	return _user$project$Layout_Types$GroomingMsg(
		_user$project$Router$locationParser(location));
};
var _user$project$MainWithLayout$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_user$project$MainWithLayout$layoutLocationParser,
...
var Elm = {};
Elm['MainWithLayout'] = Elm['MainWithLayout'] || {};
if (typeof _user$project$MainWithLayout$main !== 'undefined') {
    _user$project$MainWithLayout$main(Elm['MainWithLayout'], 'MainWithLayout', undefined);
}
