					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {user: a, uuid: b, story: c, storyInput: d, userInput: e, error: f, votes: g, revealVotes: h, sizedStories: i, isDataLoaded: j};
									};
								};
							};
						};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['MainWithLayout'], 'MainWithLayout', typeof _user$project$MainWithLayout$main === 'undefined' ? null : _user$project$MainWithLayout$main);
